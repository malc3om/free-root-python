#!/usr/bin/env python3
"""
FreeRoot Python - Standalone version
Ubuntu PRoot environment for Python notebooks
Based on https://github.com/foxytouxxx/freeroot

No installation required - just download this file and run:
    
    from standalone_freeroot import setup_ubuntu
    fr = setup_ubuntu()
    ...
    def install(self):
        ...
        try:
            ...
            if has_ipython:
                ...
                print("\n✅ FreeRoot Python Installation Complete!")
                print("Ubuntu environment is ready to use.\n")
        except Exception as e:
