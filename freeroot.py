#!/usr/bin/env python3
"""
FreeRoot: Ubuntu PRoot environment for Python notebooks

This module allows you to run Ubuntu commands in Python notebooks
even in restricted environments without sudo access.
"""
...
def setup_ubuntu(rootfs_dir=None):
    """
    Set up a FreeRoot instance with Ubuntu.
    
    Args:
        rootfs_dir: Custom directory for the root filesystem
        
    Returns:
        FreeRoot: A configured FreeRoot instance
    """
    fr = FreeRoot(rootfs_dir)
    fr.install()
    return fr